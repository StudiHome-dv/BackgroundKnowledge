...
**Universal Strengthening:** `GC-RPG-001 Evidence → UC-DESIGN-006 — Progression Should Alter Decisions`  
...
2. **가장 강한 발견은 신규 RPG Core라기보다 `UC-DESIGN-006 — Progression Should Alter Decisions`의 강화 필요성이다.**
   - RPG 관점에서는 성장 후:
     - 새 Capability
     - 새 Role
     - 새 Solution
...
# 6.1 UC-DESIGN-006 — Progression Should Alter Decisions
...
> **`UC-DESIGN-006 — Progression Should Alter Decisions`이 RPG 검토에서 매우 강한 상위 Rule이라는 점이 재확인되었다.**
