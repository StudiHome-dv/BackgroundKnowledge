...
**Status:** `CANDIDATE`  
**Origin:** `NEW GENRE CORE / UNIVERSAL RECLASS CANDIDATE`
...
| GC-ACTION-003 | Execution Failures Need Legible Attribution | NEW / UC RECLASS CANDIDATE | KEEP AS CANDIDATE | HIGH stealth / MEDIUM broad Action |
